...
namespace Fudee_v2.Data.Migrations
{
    ...
    [Migration("20221208195510_nowe_tabele")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fudee_v2.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("Fudee_v2.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("Fudee_v2.Models.Dish", b =>
                {
            ...
            modelBuilder.Entity("Fudee_v2.Models.Opinion", b =>
                {
            ...
            modelBuilder.Entity("Fudee_v2.Models.Restaurant", b =>
                {
                    b.Property<int>("IdRestaurant")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Fudee_v2.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Fudee_v2.Models.Dish", b =>
                {
                    b.HasOne("Fudee_v2.Models.Restaurant", "Restaurant")
                        .WithMany("Dishes")
            ...
            modelBuilder.Entity("Fudee_v2.Models.Opinion", b =>
                {
                    b.HasOne("Fudee_v2.Models.AppUser", "User")
                        .WithMany("Opinions")
                        .HasForeignKey("Id")
            ...
            modelBuilder.Entity("Fudee_v2.Models.Restaurant", b =>
                {
                    ...
                    b.HasOne("Fudee_v2.Models.Address", "Address")
                        .WithOne("Restaurant")
                        .HasForeignKey("Fudee_v2.Models.Restaurant", "IdAddress")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fudee_v2.Models.Category", "Category")
                        .WithMany("Restaurants")
